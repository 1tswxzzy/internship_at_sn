...
def main():
    ...
    while True:
        ...
        # ==================== 第二步：获取工作表基本信息 ====================
        ws, max_h, max_l = get_worksheet_info(file_path)
        if ws is None:
        ...
        # ==================== 第四步：后续扩展区域 ====================
        # 示例：这里可以调用新函数对每个学校进行处理
        # for i in range(max_size):
        #     row_index = head_size + 1 + i
        #     process_row(ws, row_index, max_l)
        print("\n（此处为预留扩展点，可添加具体的数据处理逻辑）")
